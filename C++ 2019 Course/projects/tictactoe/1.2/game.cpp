 ...
 * Version 1.2
 *
 * Created by Dmytro Ostapenko (xXDima212DimaXx) 2019.06.11
 *
 * Created in 2 days
 *
 * The final project
...
int main (void) {
    ...
    cout << "       [4] Exit" << endl;
    cout << "" << endl;
    cout << "   Enter your choice (Play with player [1] - default): ";
    intro();
}
...
void gamesession (int type) {
    if (type == 1) {
        ...
        cout << "Chose the player: 1 - Random player, 2 - X, 3 - O, Random - default: ";
        int ch;
        cin >> ch;
        ...
        cout << "enter 10 to back to main menu" << endl;
        ...
        for( ; ; ) {
            ...
            for ( ; ; ) {
                if ((cin.fail() == 0)) {
                    ...
                    cin.clear();
                    cin.ignore(numeric_limits<streamsize>::max(), '\n');
                    cout << "Letters is not allowed" << endl;
                    cout << "Position X: ";
                    cin >> first;
                }
            }
            ...
            if (fa >= 0 && fa < 3 && sa >= 0 && sa < 3) {
                if (arr[sa][fa] == 1 || arr[sa][fa] == 2) {
                    ...
                    if (arr[0][0] == 1 && arr[0][1] == 1 && arr[0][2] == 1) {
                        ...
                        cout << "" << endl;
                        int r;
                        cout << "Play again? (1 = play, 2 = back to main menu, another = exit): ";
                        cin >> r;
        ...
        cout << "Chose the player: 1 - Random, 2 - X (Player), 3 - Bot, Random - default: ";
        int ch;
        cin >> ch;
...
void intro (void) {
    ...
    if (f == 1) {
        ...
        cout << "│ └───┴───┴───┘                                               │" << endl;
        cout << "│                                                             │" << endl;
        cout << "│ Developer: Dmytro Ostapenko (xXDima212DimaXx)               │" << endl;
